...
\begin{description}
    ...
    \item[Operating system.] A qualified device must be capable of running the current version of Microsoft Windows, MacOS, or a major Linux distribution, specifically Ubuntu or Kali.\linelabel{line:os}
