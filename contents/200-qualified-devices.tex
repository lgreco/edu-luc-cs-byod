...
\begin{itemize}
    ...
    \item {\color{magenta}{Minimum Requirements}}
        ...
        \begin{description}
            ...
            \item[Operating system.] A qualified device must be capable of running one of the following operating systems or higher: Windows 11, MacOS Sonoma, or {\color{red} list acceptable Linux variants.}
            ...
            \item[Access to Command Line Interface.]
            
        \end{description}

    \item {\color{blue}{Optional Requirements}}
